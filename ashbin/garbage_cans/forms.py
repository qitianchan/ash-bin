...
from wtforms.fields import StringField, SubmitField, DecimalField, IntegerField, FloatField
...
class GarbageCanForm(Form):
    ...
    def save_form(self, garbage_can):
        ...
        garbage_can.longitude = float(self.longitude.data)
        garbage_can.latitude = float(self.latitude.data)
        garbage_can.save()
